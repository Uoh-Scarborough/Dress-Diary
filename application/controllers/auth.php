...
class Auth extends Controller {
	...
	function index()
	{
		...
		elseif (!$this->ion_auth->is_admin())
		{
			...
			redirect($this->config->item('auth/login'), 'refresh');
		}
		else
		{
			...
			$this->layout->loadView('auth/index', $this->data, false, false );
	...
	function login()
	{
		...
		{  //the user is not logging in so display the login page
			...
			$this->layout->loadView('auth/login', $this->data, false, false );
	...
	function change_password()
	{
		...
		{ //display the form
			...
			//render
			$this->layout->loadView('auth/change_password', $this->data, false, false );
	...
	function forgot_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			$this->layout->loadView('auth/forgot_password', $this->data, false, false );
		}
		else
		{
	...
	function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->layout->loadView('auth/deactivate_user', $this->data, false, false );
		}
		else
		{
	...
	function create_user()
	{
		...
		$this->layout->loadView('auth/create_user', $this->data, false, false );
		}
	}
